...
/**
 * This is the class representing employee as a member
 */
public class Employee implements Member {
  private Integer memberId;
  private String name;
  private int pointsBalance = 0;
  private static final int pointsAccruedThreshold = 5;
  ...
  public Employee(Integer memberId, String name, int pointsBalance) {
    super();
  ...
  public void setTotalIndividualMemberSales(int totalIndividualMemberSales) {
    Employee.totalIndividualMemberSales = totalIndividualMemberSales;
  }
  ...
  public void setTotalIndividualMemberLPoints(int totalIndividualMemberLPoints) {
    Employee.totalIndividualMemberLPoints = totalIndividualMemberLPoints;
  }
  ...
  public void setTotalIndividualMemberDiscounts(int totalIndividualMemberDiscounts) {
    Employee.totalIndividualMemberDiscounts = totalIndividualMemberDiscounts;
  }
}
